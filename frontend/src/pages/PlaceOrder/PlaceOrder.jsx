    ...
    <form onSubmit={placeOrder} className='place-order'>
      <div className="place-order-left">
        ...
        <div className="multi-fields">
          <input required  name='firstName' value={data.firstName} onChange={onChangeHandler} type="text" placeholder='firstName' />
        ...
        <div className="multi-fields">
          <input required  name='city' value={data.value} onChange={onChangeHandler} type="text" placeholder='City' />
